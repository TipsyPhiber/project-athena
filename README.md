...
git clone [https://github.com/TipsyPhiber/project-athena.git](https://github.com/TipsyPhiber/project-athena.git)
cd project-athena
...
Commit: Pushes to main trigger the pipeline.

Test: Maven automatically runs JUnit tests (TDD validation).

Build: Compiles the Java JAR and optimizes Angular static assets.
